...
export default function VisitorNoteUploadPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <PageHeader title="Upload a Note" description="Upload a note file to try AI summarisation for free." />
      <Card>
        <CardContent className="space-y-5 pt-5">
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-3">
            <div className="grid grid-cols-3 gap-3">
              <div className="space-y-1">
                <Label>Subject</Label>
                <Input {...form.register('subject')} placeholder="Optional" disabled={uploading} />
              </div>
              <div className="space-y-1">
                <Label>Topic</Label>
                <Input {...form.register('topic')} placeholder="Optional" disabled={uploading} />
              </div>
              <div className="space-y-1">
