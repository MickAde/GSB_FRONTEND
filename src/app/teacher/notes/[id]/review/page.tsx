...
export default function TeacherNoteReviewPage(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-3xl space-y-4">
      <PageHeader
        ...
        description="Check the OCR output below. Correct any errors before the AI summary is generated."
      />
      ...
      <OCRReviewEditor noteId={id} rawText={note.raw_ocr_text} basePath="/teacher/notes" />
    </div>
  );
}
