    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold text-gray-900 break-words">{note.file_name}</h1>
      ...
      {/* AI summary — only shown when READY */}
      {note.status === 'READY' ? (
        <AISummaryCard note={note} />
      ) : note.status === 'AWAITING_STUDENT_APPROVAL' ? (
        <Card>
          <CardContent className="flex flex-col items-center gap-3 py-8">
            <p className="text-sm text-amber-600 font-medium">Review required before summary can be generated.</p>
